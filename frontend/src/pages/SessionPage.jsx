...
import VideoCallUI from "../components/VideCall/VideoCallUI";
...
function SessionPage() {
  ...
  //redirect the participant when the session get ended
  useEffect(() => {
        ...
        <PanelGroup direction="horizontal">
          ...
          <Panel defaultSize={50} minSize={30}>
            <PanelGroup direction="vertical">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        {problemData?.category && (
                          <p className="text-base-content/60 my-1">
                            {problemData.category}
                          </p>
                        )}
              ...
              <PanelResizeHandle className="h-2 bg-base-100 hover:bg-primary transition-colors cursor-row-resize" />
